    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_signup.setOnClickListener(view ->  {
            ...
            if (!cnfrm.equals(password)) {
                Toast.makeText(register.this, "The password and confirm password does not matches", Toast.LENGTH_SHORT).show();
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(register.this, "Not allowed. Try Again", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        });
